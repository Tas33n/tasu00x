...
def start(update, context):
    ...
    buttons.buildbutton("Join Channel", "https://t.me/MirrorChan_x0")
    buttons.buildbutton("Mirror Group", "https://t.me/mirrorchan_x")
    
    reply_markup = InlineKeyboardMarkup(buttons.build_menu(2))
    if CustomFilters.authorized_user(update) or CustomFilters.authorized_chat(update):
        start_string = f'''
Welcome | Mirror Chan is ready for you
